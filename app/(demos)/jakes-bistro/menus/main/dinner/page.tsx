...
export default function page(){
    ...
    const MENU_URL = "https://www.tradulio.com/menu/Jake's%20Bistro/jakes-on-main-dinner-19";
    ...
    return(
        <div className="w-full h-[90vh]">
            <div className="fixed top-60 right-[10vw] flex">
                ...
                <a href="https://www.tradulio.com/menu/Jake's%20Bistro/jakes-on-main-dinner-19">
            ...
            <iframe
                ...
                src="/jakes-bistro/menus/jakes_on_main_dinner.pdf#toolbar=0"
            />
        </div>
    )
}