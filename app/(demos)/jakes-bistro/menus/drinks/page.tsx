...
export default function page(){
    ...
    const MENU_URL = "https://www.tradulio.com/menu/Jake's Bistro/drinks-menu-15";
    ...
    return(
        ...
        <div className="w-full h-[90vh]">
            <div className="fixed top-60 right-[10vw] flex">
                ...
                <a href="https://www.tradulio.com/menu/Jake's%20Bistro/drinks-menu-15">
            ...
            <iframe
                ...
                src="/jakes-bistro/menus/jakes_bistro_drinks.pdf#toolbar=0"
            />
        </div>
        </>
    )
