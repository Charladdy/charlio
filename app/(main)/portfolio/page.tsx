        ...
        <div className="page-content">
            ...
            <div className="md:flex">
                <div className="flex-1 pl-5 md:pr-5 md:pl-0  border-b md:border-r md:border-b-0">
                    <div className="h-35 mb-5">
                        <a href="/jakes-bistro" target="_blank"><Image className="absolute p-5 w-75 hover:w-78" src="/jakes-bistro/JakesBistro.png" width={300} height={300} alt="Jake's Bistro"/></a>
                    </div>
                ...
                <div className="flex-1 pl-5">
                    <div className="h-48 mb-5">
                        <a href="/yardsdale-plumbing-co" target="_blank"><Image className="absolute p-5 w-75 hover:w-78" src="/plumb-logo3.png" width={250} height={250} alt="Jake's Bistro"/></a>
                    </div>            
            ...
            <div className="md:flex">
                ...
                <div className="flex-1 pl-5 border-b md:border-b-0">
                    <div className="h-38 mb-5">
                        <a href="https://charladdy.com"><Image className="absolute p-5 w-75 hover:w-78" src="/Charladdy_Wordmark_Green.png" width={250} height={250} alt="Charladdy"/></a>
                    </div>
            ...
            <div className="md:flex">
                <div className="flex-1 pl-5 md:pr-5 md:pl-0 pt-8 border-b md:border-r md:border-b-0">
                    <div className="h-16 mb-5">
                        <a href="https://mathematika.io"><Image className="absolute p-5 w-75 hover:w-78" src="/mathematika_wordmark.png" width={250} height={250} alt="Mathematika"/></a>
                    </div>
                ...
                <div className="flex-1 pl-5 pt-8">
                    <div className="h-16 mb-5">
                        <a href="https://vocabulizer.io"><Image className="absolute p-5 w-75 hover:w-78" src="/vocabulizer_wordmark.png" width={250} height={250} alt="Vocabulizer"/></a>
                    </div>
